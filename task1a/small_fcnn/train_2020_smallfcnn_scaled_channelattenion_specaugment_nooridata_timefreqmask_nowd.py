...
experiments = 'exp_2020_smallfcnn_scaled_channelattention_specaugment_nooridata_timefreqmask_nowd'
...
TrainDataGen = MixupGenerator_timefreqmask_splitted(feat_path, train_csv, NumFreqBins, 
