...
val_csv = 'evaluation/fold1_evaluate_3class.csv'
feat_path = 'features/logmel128_scaled/'

# if following trained models are used, should get vote result of acc 93.2%, predtions 
# saved in ./class3_results_acc0.932.txt
model_path = 'pretrained_models/3class-resnet-model-0.9141.hdf5'
model_path2 = 'pretrained_models/3class-fcnn-model-0.9290.hdf5'
...
np.savetxt("class3_results_acc0.932.txt", preds, fmt = '%.7f')
