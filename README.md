...
**New** We add a list on recent **related ASC works** containing discussion with this open resource ASC studies. Check the recent works section [here](https://github.com/MihawkHu/DCASE2020_task1/blob/master/README.md#more-recent-related-works) and welcome to open an issue for adding related reference with the open resouce studies.   
